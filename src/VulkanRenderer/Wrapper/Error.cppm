...
export module NYANVulkan:Error;
import std;
...
export namespace nyan::vulkan
{
	...
	class [[nodiscard]] InstanceCreationError
	{
	public:
	...
	class [[nodiscard]] PhysicalDeviceCreationError
	{
	public:
		enum class Type : uint32_t
		{
	...
	class [[nodiscard]] LogicalDeviceCreationError
	{
	public:
		enum class Type : uint32_t
		{
	...
	class [[nodiscard]] PhysicalDeviceSelectionError
	{
	public:
		enum class Type : uint32_t
		{
...
constexpr nyan::vulkan::Error::Error(const VkResult result, const std::source_location& location) noexcept :
...
constexpr nyan::vulkan::Error::operator nyan::vulkan::Error::Type() const noexcept
{
	return get_result();
}

constexpr nyan::vulkan::Error::Type nyan::vulkan::Error::get_result() const noexcept
{
	return m_result;
}
constexpr const char* nyan::vulkan::Error::get_message() const noexcept
{
...
constexpr nyan::vulkan::InstanceCreationError::InstanceCreationError(Type type,
	const std::source_location& location) noexcept :
	m_type(type)
{
}

constexpr nyan::vulkan::InstanceCreationError::Type nyan::vulkan::InstanceCreationError::get_type() const noexcept
{
	return m_type;
}

constexpr const char* nyan::vulkan::InstanceCreationError::get_message() const noexcept
{
	//return m_message;
	return nullptr;
}

constexpr nyan::vulkan::PhysicalDeviceCreationError::PhysicalDeviceCreationError(Type type,
	const std::source_location& location) noexcept :
	m_type(type)
{
}

constexpr nyan::vulkan::PhysicalDeviceCreationError::Type nyan::vulkan::PhysicalDeviceCreationError::
get_type() const noexcept
{
	return m_type;
}

constexpr const char* nyan::vulkan::PhysicalDeviceCreationError::get_message() const noexcept
{
	//return m_message;
	return nullptr;
}

constexpr nyan::vulkan::LogicalDeviceCreationError::LogicalDeviceCreationError(Type type,
	const std::source_location& location) noexcept :
	m_type(type)
{
}

constexpr nyan::vulkan::LogicalDeviceCreationError::Type nyan::vulkan::LogicalDeviceCreationError::
get_type() const noexcept
{
	return m_type;
}

constexpr const char* nyan::vulkan::LogicalDeviceCreationError::get_message() const noexcept
{
	//return m_message;
	return nullptr;
}

constexpr nyan::vulkan::PhysicalDeviceSelectionError::PhysicalDeviceSelectionError(Type type,
	const std::source_location& location) noexcept :
	m_type(type)
{
}

constexpr nyan::vulkan::PhysicalDeviceSelectionError::Type nyan::vulkan::PhysicalDeviceSelectionError
::get_type() const noexcept
{
	return m_type;
}

const char* nyan::vulkan::PhysicalDeviceSelectionError::get_message() const noexcept
{
	//return m_message;
	//return magic_enum::enum_names<nyan::vulkan::PhysicalDeviceSelectionError::Type>()[static_cast<std::underlying_type<nyan::vulkan::PhysicalDeviceSelectionError::Type>::type>(m_type)].data();
